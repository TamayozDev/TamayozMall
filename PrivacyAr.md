...
### مقدمة
ستساعدك سياسة الخصوصية الخاصة بنا على فهم ماهية المعلومات التي نجمعها في * تميز * ، وكيف يستخدمها * تميز مول * ، وما هي الخيارات المتاحة لك.
* تميّز * أنشأ تطبيق * تميز مول * كتطبيق مجاني. يتم توفير هذه الخدمة من قبل * التميز مول * دون أي تكلفة وهي مخصصة للاستخدام كما هي.
